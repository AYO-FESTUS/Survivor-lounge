  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center">
      ...
      <div className="w-full h-fit px-4">
        ...
        <p className="text-lg text-gray-700 max-w-2xl mx-auto px-4 py-8 [word-spacing:0.2em] tracking-wider">
      ...
      <div className="w-full h-fit px-4">
        <h3 className="font-bold text-2xl text-center mt-4">Our Mission</h3>
      ...
      <div className="w-full h-fit">
        <h3 className="font-bold text-2xl text-center mb-4">What We Do</h3>
          ...
          {mission.map((item) => (
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <p className="text-lg text-gray-700 [word-spacing:0.1em] tracking-wide">
                {item.title}
              </p>
            </div>
          ))}
      ...
      <p className="text-lg text-gray-700 text-center px-4 py-8 max-w-2xl mx-auto [word-spacing:0.2em] tracking-wider">
