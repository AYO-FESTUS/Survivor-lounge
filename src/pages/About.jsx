...
const About = () => {
  return (
    <section className="w-full min-h-screen flex flex-col items-center bg-gray-100">
      <div className="relative w-full h-52 bg-cover bg-no-repeat bg-center bg-[url('/images/therapy.jpg')] md:h-100">
      ...
      <div className="w-full h-fit px-4">
        ...
        <p className="text-lg text-black max-w-2xl mx-auto px-4 py-8 [word-spacing:0.2em] tracking-wider">
      ...
      <div className="w-full h-fit">
        ...
        <div className="w-full h-fit px-4 md:grid md:grid-cols-2 lg:grid-cols-2 gap-6 lg:px-20">
          {mission.map((item) => (
            <div
              key={item.id}
              className="flex flex-col items-center py-6 px-4 rounded-lg bg-[#B89B5E] mb-4 border-dashed border-1 border-[#B89B5E]/40 hover:shadow-lg transition duration-300"
            >
              <img
                src={item.img}
                alt={item.title}
      ...
      <p className="text-lg text-black text-center px-4 py-8 max-w-2xl mx-auto [word-spacing:0.2em] tracking-wider">
