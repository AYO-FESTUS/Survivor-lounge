        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center md:space-x-12">
          ...
          >
            ...
            <div className="flex flex-row items-center justify-center md:justify-start gap-3">
              ...
              <p className="text-base md:text-lg text-gray-100 tracking-wide whitespace-nowrap">
  ...
  <div className="max-w-7xl mx-auto px-4 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-lg tracking-wider [word-spacing:0.2em]">
...
<section className="bg-gray-95 py-16">
  <img
