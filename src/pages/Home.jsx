          ...
          <div className="relative z-20 flex items-center justify-center h-full px-4">
            <div className="text-center text-white max-w-3xl w-full">
              ...
              <h2 className="text-base sm:text-lg md:text-xl font-medium mb-6 tracking-wider">
                Empowering migrant survivors of domestic abuse and unmentored
                young adults to thrive with confidence, skills, and hope.
              </h2>
        ...
        <section className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center md:space-x-12">
            ...
            >
              ...
              <p className="text-lg text-black max-w-5xl mx-auto px-4 py-8 [word-spacing:0.2em] tracking-wider">
                The Survivor’s Lounge empowers individuals to rebuild their
                lives beyond crisis and systemic limitations. We support migrant
                survivors of domestic abuse and young adults without mentors
                through trauma-informed guidance, practical skills development,
              ...
              <div className="flex flex-row items-center justify-center md:justify-start gap-3">
                ...
                <p className="text-base md:text-lg text-gray-700 tracking-wide whitespace-nowrap">
        ...
        <section className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Box 1 */}
              <div className="bg-cover bg-center bg-no-repeat bg-white rounded-lg shadow-lg p-8 flex flex-col items-center text-center">
                ...
                <p className="text-black lg tracking-wider [word-spacing:0.2em]">
                  We understand the unique barriers faced by migrants and
                  unmentored youth and tailor our approach to meet their
                  specific needs.
                </p>
              </div>
              ...
              <div className="bg-cover bg-center bg-no-repeat bg-white rounded-lg shadow-lg p-8 flex flex-col items-center text-center">
                ...
                <p className="text-black lg tracking-wider [word-spacing:0.2em]">
                  We combine advisory, skills development, and mentorship for
              ...
              {/* Box 3 */}
              <div
                className="bg-cover bg-center bg-no-repeat bg-white rounded-lg shadow-lg p-8 flex flex-col items-center text-center"
              ...
              >
                ...
                <p className="text-black 1g tracking-wider [word-spacing:0.2em]">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <motion.div
                ...
                transition={{ duration: 1 }}
                viewport={{ once: true }}
                className="bg-[#B89B5E] rounded-2xl p-6 shadow-lg flex flex-col justify-between h-full"
              >
                <h2 className="text-4xl font-bold text-white mb-4 text-center">
                  Partner With Us
                </h2>
                <p className="text-lg text-gray-100 flex-grow px-4 py-4 tracking-wider text-center">
                  We collaborate with community organisations, local
                  authorities, and funders to expand our impact. If you’re
                  passionate about supporting migrant survivors and unmentored
                  youth, let’s work together to create change.
                </p>
                <button className="flex justify-center mt-auto">
                  <a
                    href="#"
                    className="bg-white text-[#B89B5E] font-semibold border border-[#B89B5E] text-sm sm:text-base px-6 py-3 rounded-md hover:bg-[#A4844E] transition"
                  >
                    Partner With Us
                  </a>
                </button>
              ...
              >
                ...
                <p className="text-lg text-gray-100 flex-grow px-4 py-8 tracking-wider text-center">
                  If you are a survivor of abuse or a young adult seeking
                  mentorship, we are here for you. <br /> Reach out to begin
                  your journey of healing and growth.
                </p>
                <button className="flex justify-center mt-auto">
                  <a
                    href="#"
                    className="bg-white text-[#B89B5E] font-semibold text-sm sm:text-base px-6 py-3 rounded-md hover:bg-[#A4844E] transition"
                  >
                    Get Support
                  </a>
                </button>
