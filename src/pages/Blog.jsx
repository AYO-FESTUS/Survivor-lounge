    ...
    <div className="w-full bg-gray-100">
      ...
      <div className="container mx-auto w-full px-4 py-8">
        ...
        {combinedPosts.map((post, index) => {
          ...
          return (
            <section className="w-full h-fit flex flex-col md:grid mb-4 md:grid-cols-2 md:grid-rows-1">
              <div
                key={index}
                className="bg-[#B89B5E] h-fit w-full shadow-md rounded-[1rem] px-4 py-6"
              >
                {post.imageUrl && (
                  <img
                    src={post.imageUrl}
                    alt={post.title}
                    className="w-full h-[15rem] object-cover rounded mb-4"
                  />
                )}
        ...
        <section className="w-full mt-4 mb-12">
          <div
            className="relative w-full h-[18rem] mb-8 bg-[url('/blog/helplines.jpeg')] bg-cover bg-no-repeat bg-center grid place-content-center md:h-[20rem]
          "
          >
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
            {/* <img
              src="/blog imag/helplines.jpeg"
              alt="Emergency helplines support"
              className="w-full h-[15rem] object-cover"
            /> */}

            <h2 className="text-black text-4xl font-bold text-center px-4">
